...
class StockAlertsPageOld extends StatefulWidget {
  const StockAlertsPageOld({super.key});

  @override
  State<StockAlertsPageOld> createState() => _StockAlertsPageOldState();
}

class _StockAlertsPageOldState extends State<StockAlertsPageOld> {
