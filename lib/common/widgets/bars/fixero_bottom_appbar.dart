...
import '../../../features/vehicle_management/views/vehicle_home_view.dart';
      ...
      child: BottomAppBar(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(child: _navItem(context, Icons.directions_car, 'Vehicles', theme, const VehicleHomeView(), VehicleHomeView.routeName, currentRoute)),
